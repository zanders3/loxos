...
OBJS := build/boot.o build/main.o build/vga.o build/common.o build/paging.o build/gdt.o build/isr.o
...
build/%.o: src/%.cpp
	gcc -g -c $< $(OPTIONS) $(sources) -o $@

build/kernel.bin: $(OBJS) src/linker.ld
	gcc -n -o $@ -T src/linker.ld $(OPTIONS) $(OBJS)
